...
/* You cannot remove/modify the data members below, 
   ...
   However, you can add more data members.              */
    ...
    private:
        ...
        int* elements;      // Array to hold Queue elements
...
/* You cannot remove/modify the public methods below. 
   ...
   like "printQueue()", etc.                            */
        ...
        // Getter function for frontindex
        unsigned int getFrontIndex() const;

        // Getter function for backindex
        unsigned int getBackIndex() const; 



        // Getter function for elementCount
